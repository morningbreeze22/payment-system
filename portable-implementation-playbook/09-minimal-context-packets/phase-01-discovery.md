...
Read: playbook Section F status codes; Playbook Index BLOCKED list; file 26 T.1–T.3; requirment-v4.md §2.4 (round 18 — the canonical greenfield fact itself, incl. the bootstrap-restoration condition; the report records it was read and the query scope matches its population claim). Invariant: no "probably" — IMPLEMENTED/PARTIAL/MISSING/UNCLEAR only; DIV-3/DIV-4 register rows highlighted (they block cards, rule 21).
