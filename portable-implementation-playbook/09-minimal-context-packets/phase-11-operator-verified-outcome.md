...
```text
[OP-04a] Shared ops-endpoint contract + retry/reject/annotate
...
```text
[OP-04b] Reprocess APPROVAL side
...
```text
[OP-04d] Queue views + authz/plan tests
...
```text
[OP-04e] Cross-path integration suite + evidence
