...
Tests: §6.7 regression trace; ties at admission; T1; T-35 (never-seen-scope refused; disjoint first snapshots serialize; pause-after-admission/after-block-1 overtake → next block aborts; failed-validation advances neither watermark). Stop: merged.
```
