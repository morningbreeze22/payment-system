...
Placeholders: none (DBA ops/audit schema). Mappings/inputs REQUIRED before AUD-01 can resolve: <request_id_type> (D-02), CA-1 category tokens (CA-1 published), audit schema/tablespaces/roles, environment-qualified policy name, audit execution principal + PDB scope (DBA).
