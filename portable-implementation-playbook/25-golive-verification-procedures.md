...
Evidence is IMMUTABLE once captured: a change to any
...
2. Walk the MONEY_SAFETY_BLOCKING class next: Q5a, Q5b, Q8, Q9, Q11, Q12, Q14, Q16, Q17, Q27, and Q29's minimal exit set. Any FAIL or missing
   evidence → NO-GO, stop here — this class has NO owner+plan
   waiver; reclassification needs a safety review, not this meeting.
   ONE defined exception: Q5b ALONE may stand as
...
4. Evidence integrity: validate manifest.yaml against the
