...
- **Local code areas to discover:** none.
- **How to locate:** n/a.
- **Implementation instructions:** adopt Section J's matrix (T-01..T-37) as the seed; add the spec-named entries above; assign each entry an owner-type and the phase whose task implements it; keep IDs stable; version the catalog.
