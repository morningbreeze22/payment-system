...
1. **Adversarial review rounds.** Twenty-two external adversarial
   ...
   comments, invalid-marker anchoring — all closed by mechanism or
   removal, see `event-model-v2.md` §0; no clean round yet after
   twenty-two). The baseline's mechanisms have
