...
1. **Adversarial review rounds.** Twenty-five external adversarial
   ...
   `REJECTED_VALIDATION` path — all closed by mechanism or removal,
   see `event-model-v2.md` §0; no clean round yet after twenty-five).
