...
FORBIDDEN = [
    ...
    ("approver identities as execution inputs (round 4: approval_id only)",
     re.compile(r"approvers\[2\]|two distinct (?:authenticated |enterprise-authenticated )?approver", re.I),
     re.compile(r"derived|NEVER passed|never from parameters|never approver-identity|lint", re.I)),
